<x-navbar>
        ...
        <ol class="breadcrumb">
            ...
            <li class="breadcrumb-item active"> / Ordens / Ordem de serviço N°{{ $id }} / Editar</li>
        </ol>
        ...
        <form>
            ...
            <div class="text-center mt-4">
                <button type="submit" class="btn btn-success">Editar Ordem</button>
            </div>
